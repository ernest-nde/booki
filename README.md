# JUST AN HTML & CSS Project
The following code is just a small project whitch is include in Web Dev learning program on <code>openclassrooms.com</code> where I took almost all the knowledge I will use here.
